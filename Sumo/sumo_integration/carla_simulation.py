...
class CarlaSimulation(object):
    ...
    def __init__(self, host, port, step_length):
        ...
        vices_car_list = set_Vice(create_vices(vehicle_traffic, vehicle))  # 创建副车
    ...
    def tick(self):
        ...
        current_actors = set([vehicle.id for vehicle in self.world.get_actors().filter('vehicle.*')])
